...
const packageImages: Record<string, string[]> = {
  "ooty-delight": [ootyImg, munnarImg, coorgImg, kodaikanalImg, shimlaImg],
  "kodaikanal-escape": [kodaikanalImg, ootyImg, munnarImg, coorgImg, shimlaImg],
  "munnar-magic": [munnarImg, kodaikanalImg, ootyImg, coorgImg, shimlaImg],
  "coorg-adventure": [coorgImg, munnarImg, ootyImg, kodaikanalImg, shimlaImg],
  "shimla-manali": [shimlaImg, coorgImg, munnarImg, ootyImg, kodaikanalImg],
};
...
const BookingPage = () => {
  ...
  const images = packageImages[pkg.id] || [
    categoryImages[categoryId || ""] || hillStationImg,
    ootyImg,
    munnarImg,
    kodaikanalImg,
    coorgImg,
      ...
      <div className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-10">
            ...
            <div className="mt-4 inline-block px-4 py-2 bg-primary/10 text-primary rounded-full font-semibold">
          ...
          {/* Places Covered */}
          <div className="bg-card rounded-2xl p-6 mb-10 border border-border">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button
              variant="outline"
              size="xl"
              className="w-full sm:w-auto border-2 border-[#25D366] text-[#25D366] hover:bg-[#25D366] hover:text-white"
              onClick={() =>
                window.open(
                  "https://wa.me/919876543210?text=Hi, I'm interested in the " +
