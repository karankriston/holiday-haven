...
const PrivacyPage = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        "OotyEscapes does not collect or process any online payments through this website.",
    ...
    },
    {
      ...
      content: [
        ...
        "Your data is accessed only by authorized personnel of OotyEscapes."
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        "OotyEscapes may update this Privacy Policy at any time without prior notice. Changes will be updated on this page."
      ]
    }
  ];
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              At OotyEscapes, we respect your privacy and are committed to protecting any personal information you share with us. This Privacy Policy explains how we collect, use, and protect your information.
            </p>
          </div>
