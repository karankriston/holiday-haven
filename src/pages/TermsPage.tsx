  ...
  const sections = [
    {
      ...
      content: [
        "OotyTourPlanners does not provide online booking or payment through the website.",
    ...
    },
    {
      ...
      content: [
        ...
        "OotyTourPlanners reserves the right to modify or cancel any part of the tour for safety or operational reasons."
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        "OotyTourPlanners is not responsible for loss of personal belongings.",
    ...
    },
    {
      ...
      content: [
        ...
        "OotyTourPlanners is not liable for any injury, accident, illness, or loss during the trip."
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        "OotyTourPlanners is not responsible for delays or cancellations due to natural calamities, landslides, strikes, government restrictions, or any events beyond our control."
      ]
    },
    {
      ...
      content: [
        ...
        "By contacting OotyTourPlanners, you agree to these terms and conditions."
      ]
    },
    {
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Welcome to OotyTourPlanners. By using our website and contacting us for tour bookings, you agree to the following terms and conditions.
            </p>
          </div>
