        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/category/wildlife/tour/toy-train" className="text-primary-foreground/70 hover:text-primary transition-colors">Toy Train Ride</Link></li>
              <li><Link to="/category/pilgrimage/tour/romantic-ooty" className="text-primary-foreground/70 hover:text-primary transition-colors">Honeymoon Package</Link></li>
              <li><Link to="/category/hill-stations/tour/coonoor-scenic" className="text-primary-foreground/70 hover:text-primary transition-colors">Coonoor Experience</Link></li>
              <li><Link to="/category/hill-stations/tour/pykara-nature" className="text-primary-foreground/70 hover:text-primary transition-colors">Pykara Adventure</Link></li>
            </ul>
          </div>
